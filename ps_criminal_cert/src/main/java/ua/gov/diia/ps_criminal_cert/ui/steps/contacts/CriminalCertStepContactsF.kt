...
class CriminalCertStepContactsF : Fragment() {
            ...
            viewModel.apply {
                ...
                navigation.collectAsEffect { navigation ->
                    when (navigation) {
                        ...
                        is CriminalCertStepContactsVM.ContactsNavigation.ToConfirmation -> {
                            navigation.id?.let { navigateToConfirmation(it) }
                        }

                        is CriminalCertStepContactsVM.ContactsNavigation.ToRepeatedDeliveryConfirmation -> {
                            navigateToCriminalCertConfirmation(
                                id = navigation.id ?: "",
    ...
    private fun navigateToStatus(id: String) {
        navigate(
            CriminalCertStepContactsFDirections.actionCriminalCertStepContactsFToCriminalCertDetailsF(
    ...
    private fun navigateToCriminalCertConfirmation(id: String, phone: String, email: String) {
        navigate(
            CriminalCertStepContactsFDirections.actionCriminalCertStepContactsFToCrimeCertRepeatedDeliveryConfirmationF(
                contextMenu = args.contextMenu,
                navBarTitle = args.navBarTitle,
                applicationId = id,
                phoneNumber = phone,
                emailAddress = email,
                typeDelivery = args.deliveryType,
