...
class CriminalCertStepRequesterF : Fragment() {
            ...
            viewModel.apply {
                ...
                navigation.collectAsEffect { navigation ->
                    when (navigation) {
                        ...
                        is CriminalCertStepRequesterVM.RequesterNavigation.NavigateToBirthPlace -> {
                ...
                showRatingDialogByUserInitiative.collectAsEffect {
                    ...
                    navigateToRatingService(
                        ...
                        screenCode = CriminalCertRatingScreenCodes.SC_REQUESTER,
    ...
    private fun navigateToBirthPlace(applicationId: String) {
        navigate(
            CriminalCertStepRequesterFDirections.actionCriminalCertStepRequesterFToCriminalCertStepBirthF(
    ...
    private fun navigateToStatus(applicationId: String) {
        navigate(
            CriminalCertStepRequesterFDirections.actionCriminalCertStepRequesterFToCriminalCertDetailsF(
                contextMenu = args.contextMenu,
                navBarTitle = args.navBarTitle,
