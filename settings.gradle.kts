...
include(":libs:scanner")
project(":libs:scanner").projectDir = File(rootDir, "scanner")
include(":libs:payment")
project(":libs:payment").projectDir = File(rootDir, "payment")
...
include(":features:auth_bankid")
project(":features:auth_bankid").projectDir = File(rootDir, "auth_bankid")
include(":features:faq")
project(":features:faq").projectDir = File(rootDir, "faq")
