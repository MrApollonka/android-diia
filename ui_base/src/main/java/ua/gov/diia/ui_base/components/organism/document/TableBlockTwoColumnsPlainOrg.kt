...
@Composable
fun TableBlockTwoColumnsPlainOrg(
    ...
    Column(
        ...
        Row(
            ...
            Column(
                modifier = Modifier.conditional(!data.photo.isNullOrEmpty()) {
                    padding(start = 24.dp)
                }
            ) {
...
data class TableBlockTwoColumnsPlainOrgData(
    val id: String? = null,
...
@Composable
@Preview
fun TableBlockTwoColumnsPlainOrgDataPreview() {
    val heading = HeadingWithSubtitlesMlcData(
...
@Composable
@Preview
fun TableBlockTwoColumnsPlainOrgDataPreview_NoPhoto() {
    val heading = HeadingWithSubtitlesMlcData(
        value = "Дія Надія Володимирівна",
        subtitles = listOf("Diia Nadiia")
    )
