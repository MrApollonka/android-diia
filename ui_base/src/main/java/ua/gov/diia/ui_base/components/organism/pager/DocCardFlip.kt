...
fun DocCardFlip(
    ...
    Flipper(modifier = modifier,
        data = FlipCardData(
                    ...
                    DocCodeOrg(
                        ...
                        onUIAction = {
                            onUIAction(
                                it.copy(
                                    actionKey = it.actionKey,
                                    data = if (it.actionKey == UIActionKeysCompose.REFRESH_BUTTON) data.docType else it.data,
                                    optionalId = data.position.toString()
                                )
                            )
                        },
            ...
            cardFace = data.currentSide,
            enableFlip = data.enableFlip
        ),
        onUIAction = {
            onUIAction(
                UIAction(
...
data class DocCardFlipData(
    val actionKey: String = UIActionKeysCompose.DOC_CARD_FLIP,
    val id: String? = null,
    val docType: String,
    val position: Int,
    ...
    fun onToggleClick(toggleId: String?): DocCardFlipData {
        ...
        return this.copy(
            back = back?.onToggleClick(toggleId)
        )
    }

    fun changeCardSide(): DocCardFlipData {
        return this.copy(
